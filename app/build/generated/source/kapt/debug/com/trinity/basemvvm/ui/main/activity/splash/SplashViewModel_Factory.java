...
public final class SplashViewModel_Factory implements Factory<SplashViewModel> {
  ...
  public SplashViewModel_Factory(Provider<AppDatabase> appDatabaseProvider,
  ...
  public static SplashViewModel_Factory create(Provider<AppDatabase> appDatabaseProvider,
      Provider<InteractCommon> interactCommonProvider, Provider<Executor> schedulerProvider) {
    return new SplashViewModel_Factory(appDatabaseProvider, interactCommonProvider, schedulerProvider);
  }

  public static SplashViewModel newInstance(AppDatabase appDatabase, InteractCommon interactCommon,
      Executor scheduler) {
    return new SplashViewModel(appDatabase, interactCommon, scheduler);
  }
}
