...
public class ActivitySplashBindingImpl extends ActivitySplashBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.splashViewModel == variableId) {
            setSplashViewModel((com.trinity.basemvvm.ui.main.activity.splash.SplashViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setSplashViewModel(@Nullable com.trinity.basemvvm.ui.main.activity.splash.SplashViewModel SplashViewModel) {
