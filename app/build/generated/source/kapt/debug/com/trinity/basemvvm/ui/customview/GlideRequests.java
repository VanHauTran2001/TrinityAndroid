...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.trinity.basemvvm.ui.customview.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.trinity.basemvvm.ui.customview.GlideOptions().apply(toSet));
    }
  }
}
